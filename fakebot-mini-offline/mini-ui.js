(() => {
  ...
  function buildSettings(){
    ...
    panel.setAttribute("aria-label", "Fakebot Mini Offline settings");
    panel.setAttribute("aria-hidden", "true");
    panel.setAttribute("inert", "");

    const header = make("header", "miniSettingsHeader");
    const heading = make("div");
    heading.append(make("strong", "", "Settings"), make("span", "", "Generation, offline sound and utilities"));
    ...
    body.appendChild(settingsSection("Offline instruments", soundBody));
